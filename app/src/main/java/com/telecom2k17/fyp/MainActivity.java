...
//            Mat BGRMat = Imgcodecs.imread(ContextCompat.getDrawable(MainActivity.this, R.drawable.glasses).toString());
//
//            Mat m = new Mat();
//            Mat resizeimage = new Mat();
//            Imgproc.resize(BGRMat, resizeimage, new Size(r.width, r.height));
//            overlayImage(mRgba, BGRMat, m, new Point(r.x, r.y));
//            mRgba = m;
